...
int bridgeAudioChannelAddSource(uintptr_t channel,uintptr_t source){return bridgePlaydate->sound->channel->addSource((SoundChannel*)channel,(SoundSource*)source);}
